...
public class AliyunSendPhoneUtil {
    ...
    private static SendSmsResponse sendPhoneCode(String phoneNumbers, String signName, String templateCode, String templateParam) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4FwciT45mP9c2VQYLUVi";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "04VTKVZI1ncVBLJEXY7PuFDGZS3Jic";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendCode(String phones, String code) {
        ...
        String signName = "奶昔个人站";  //签名
        String templateCode = "SMS_186943703";  //模板
        ...
        try {
            ...
            if (messageCode.equals("OK")) {
                ...
                message = "非法手机号";
            } else if (messageCode.equals("isp.SYSTEM_ERROR")) {
                message = "系统错误";
            }
